...
nmd="/scratch/fuchs/agschulz/kalk/SplitORF/Riboseq/Output/Bowtie_transcriptome_heart_leuk_Siragusa_canonical_fastp_M_1000/NMD_transcriptome"
unique_region_dir="/scratch/fuchs/agschulz/kalk/k4neo/unique_regions"
ri="/scratch/fuchs/agschulz/kalk/SplitORF/Riboseq/Output/Bowtie_transcriptome_heart_leuk_Siragusa_canonical_fastp_M_1000/RI_transcriptome"

outputBowtie="/scratch/fuchs/agschulz/kalk/SplitORF/Riboseq/Output/Bowtie_transcriptome_heart_leuk_Siragusa_canonical_fastp"
...
three_primes="/scratch/fuchs/agschulz/kalk/SplitORF/Riboseq/Input/3_primes_Ens_110_canonical_tsl.bed"
...
source ./Bowtie_Align_transcriptomic_server_bed_M_opt.sh -i /scratch/fuchs/agschulz/kalk/SplitORF/Riboseq/Input/cDNA_fasta_Ensembl_transcripts_110.fa 10 $outputBowtie/Transcriptomic_Bowtie_index $heart_ribo $nmd/heart_NMD\
 $unique_region_dir/Unique_DNA_Regions_for_riboseq_NMD.bed $three_primes

source ./Bowtie_Align_transcriptomic_server_bed_M_opt.sh 10 $outputBowtie/Transcriptomic_Bowtie_index $heart_ribo\
 $ri/heart_RI $unique_region_dir/Unique_DNA_Regions_for_riboseq_RI.bed $three_primes
echo "===================	heart data finished"


source ./Bowtie_Align_transcriptomic_server_bed_M_opt.sh 10 $outputBowtie/Transcriptomic_Bowtie_index $leukemia_control_ribo\
...
source ./Bowtie_Align_transcriptomic_server_bed_M_opt.sh 10 $outputBowtie/Transcriptomic_Bowtie_index $leukemia_KD_ribo\
...
source ./Bowtie_Align_transcriptomic_server_bed_M_opt.sh 10 $outputBowtie/Transcriptomic_Bowtie_index $control\
...
source ./Bowtie_Align_transcriptomic_server_bed_M_opt.sh 10 $outputBowtie/Transcriptomic_Bowtie_index $treatment\
