...
nmd="/scratch/fuchs/agschulz/kalk/SplitORF/Riboseq/Output/Bowtie1_transcriptomic_v3/NMD_transcriptome"
unique_region_dir="/scratch/fuchs/agschulz/kalk/SplitORF/Riboseq/Input/Unique_regions/all_trans_refseq_tsl_filtered_ref"
ri="/scratch/fuchs/agschulz/kalk/SplitORF/Riboseq/Output/Bowtie1_transcriptomic_v3/RI_transcriptome"

outputBowtie="/scratch/fuchs/agschulz/kalk/SplitORF/Riboseq/Output/Bowtie1_transcriptomic_v3"
...
source ./Bowtie1_transcriptomic_v3.sh 10 $outputBowtie/Transcriptomic_Bowtie_index $heart_ribo $nmd/heart_NMD\
...
source ./Bowtie1_transcriptomic_v3.sh 10 $outputBowtie/Transcriptomic_Bowtie_index $heart_ribo\
 $ri/heart_RI $unique_region_dir/Unique_DNA_Regions_for_riboseq_RI.bed $three_primes
echo "===================	heart data finished"


source ./Bowtie1_transcriptomic_v3.sh 10 $outputBowtie/Transcriptomic_Bowtie_index $leukemia_control_ribo\
...
source ./Bowtie1_transcriptomic_v3.sh 10 $outputBowtie/Transcriptomic_Bowtie_index $leukemia_KD_ribo\
...
source ./Bowtie1_transcriptomic_v3.sh 10 $outputBowtie/Transcriptomic_Bowtie_index $control\
...
source ./Bowtie1_transcriptomic_v3.sh 10 $outputBowtie/Transcriptomic_Bowtie_index $treatment\
