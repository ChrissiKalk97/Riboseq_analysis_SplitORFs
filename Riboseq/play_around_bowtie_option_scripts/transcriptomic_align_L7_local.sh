...
nmd="/scratch/fuchs/agschulz/kalk/SplitORF/Riboseq/Output/Bowtie_transcriptome_heart_leuk_Siragusa_canonical_fastp_L_7/NMD_transcriptome"
unique_region_dir="/scratch/fuchs/agschulz/kalk/SplitORF/Riboseq/Input/Unique_regions/all_trans_refseq_tsl_filtered_ref"
ri="/scratch/fuchs/agschulz/kalk/SplitORF/Riboseq/Output/Bowtie_transcriptome_heart_leuk_Siragusa_canonical_fastp_L_7/RI_transcriptome"
...
source ./Bowtie_L7_local_Align_transcriptomic_server_bed.sh  10 $outputBowtie/Transcriptomic_Bowtie_index $heart_ribo $nmd/heart_NMD\
...
source ./Bowtie_L7_local_Align_transcriptomic_server_bed.sh  10 $outputBowtie/Transcriptomic_Bowtie_index $heart_ribo\
 $ri/heart_RI $unique_region_dir/Unique_DNA_Regions_for_riboseq_RI.bed $three_primes
echo "===================	heart data finished"


source ./Bowtie_L7_local_Align_transcriptomic_server_bed.sh 10 $outputBowtie/Transcriptomic_Bowtie_index $leukemia_control_ribo\
...
source ./Bowtie_L7_local_Align_transcriptomic_server_bed.sh 10 $outputBowtie/Transcriptomic_Bowtie_index $leukemia_KD_ribo\
...
source ./Bowtie_L7_local_Align_transcriptomic_server_bed.sh 10 $outputBowtie/Transcriptomic_Bowtie_index $control\
...
source ./Bowtie_L7_local_Align_transcriptomic_server_bed.sh 10 $outputBowtie/Transcriptomic_Bowtie_index $treatment\
