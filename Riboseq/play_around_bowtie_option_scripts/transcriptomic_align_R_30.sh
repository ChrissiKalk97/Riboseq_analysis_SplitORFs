...
nmd="/scratch/fuchs/agschulz/kalk/SplitORF/Riboseq/Output/Bowtie_transcriptome_heart_leuk_Siragusa_canonical_fastp_R30/NMD_transcriptome"
unique_region_dir="/scratch/fuchs/agschulz/kalk/SplitORF/Riboseq/Input/Unique_regions/all_trans_refseq_tsl_filtered_ref"
ri="/scratch/fuchs/agschulz/kalk/SplitORF/Riboseq/Output/Bowtie_transcriptome_heart_leuk_Siragusa_canonical_fastp_R30/RI_transcriptome"

outputBowtie="/scratch/fuchs/agschulz/kalk/SplitORF/Riboseq/Output/Bowtie_transcriptome_heart_leuk_Siragusa_canonical_fastp_R30"
#The following are the paths to the riboseq reads
#the two samples are merged
heart_ribo="/scratch/fuchs/agschulz/kalk/SplitORF/Riboseq/fastp/ERR3367797_fastp.fastq"
...
source ./Bowtie_R30_Align_transcriptomic_server_bed.sh -i /scratch/fuchs/agschulz/kalk/SplitORF/Riboseq/Input/cDNA_fasta_Ensembl_transcripts_110.fa 10 $outputBowtie/Transcriptomic_Bowtie_index $heart_ribo $nmd/heart_NMD\
 $unique_region_dir/Unique_DNA_Regions_for_riboseq_NMD.bed $three_primes #-i /scratch/fuchs/agschulz/kalk/SplitORF/Riboseq/Input/cDNA_fasta_Ensembl_transcripts_110.fa

source ./Bowtie_R30_Align_transcriptomic_server_bed.sh  10 $outputBowtie/Transcriptomic_Bowtie_index $heart_ribo\
 $ri/heart_RI $unique_region_dir/Unique_DNA_Regions_for_riboseq_RI.bed $three_primes
echo "===================	heart data finished"


source ./Bowtie_R30_Align_transcriptomic_server_bed.sh 10 $outputBowtie/Transcriptomic_Bowtie_index $leukemia_control_ribo\
...
source ./Bowtie_R30_Align_transcriptomic_server_bed.sh 10 $outputBowtie/Transcriptomic_Bowtie_index $leukemia_KD_ribo\
...
source ./Bowtie_R30_Align_transcriptomic_server_bed.sh 10 $outputBowtie/Transcriptomic_Bowtie_index $control\
...
source ./Bowtie_R30_Align_transcriptomic_server_bed.sh 10 $outputBowtie/Transcriptomic_Bowtie_index $treatment\
