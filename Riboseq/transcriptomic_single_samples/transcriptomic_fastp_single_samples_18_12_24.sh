...
outputBowtie="/scratch/fuchs/agschulz/kalk/SplitORF/Riboseq/Output/Bowtie_transcriptome_18_12_24_single_samples"
nmd=${outputBowtie}"/NMD_transcriptome"
unique_region_dir="/scratch/fuchs/agschulz/kalk/SplitORF/Riboseq/Input/Unique_regions/all_trans_refseq_tsl_filtered_ref_corrected_18_12_24"
...
source ../Bowtie_Align_transcriptomic_server_bed.sh  16 $outputBowtie/Transcriptomic_Bowtie_index $i\
...
R -e "library(rmarkdown); rmarkdown::render(input = '../RiboSeqReportTranscriptomic_empirical_dist.Rmd', output_file = '$outputBowtie/Riboseq_report.pdf', params=list(args = c('$outputBowtie')))"
